    ...
    return Column(
      ...
      children: [
        const Padding(
          ...
          child: Text("About Me",style: TextStyle(fontSize: 42,color: Colors.black,fontWeight: FontWeight.bold),),
        ),
        Padding(
          ...
          children:  [
            ...
            Column(
              ...
              const Padding(
                ...
                child: Text("Jawaid Ali",style: TextStyle(fontSize: 42,color: Colors.orange,fontWeight: FontWeight.bold),textAlign: TextAlign.start,),
              ),
              SizedBox(
